...
function fits_team_post_type() {
	...
	register_post_type( 'fits-team', $args );
}
add_action( 'init', 'fits_team_post_type', 0 );

// =======================================================================// 
// !                Register Custom Posts for Parnter Slider              //
// =======================================================================// 
...
function partners_post_type() {
	...
	$labels = array(
		...
		'singular_name'       => _x( 'Partner Slide', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'           => __( 'Partner Footer Slides', 'text_domain' ),
		'parent_item_colon'   => __( 'Parent Partners:', 'text_domain' ),
		'all_items'           => __( 'All Partners', 'text_domain' ),
		'view_item'           => __( 'View Partner Slide', 'text_domain' ),
		'add_new_item'        => __( 'Add New Partner Slide', 'text_domain' ),
		'add_new'             => __( 'New Partner Slide', 'text_domain' ),
		'edit_item'           => __( 'Edit Partner Slide', 'text_domain' ),
		'update_item'         => __( 'Update Partner Slide', 'text_domain' ),
		'search_items'        => __( 'Search Partner Slides', 'text_domain' ),
		'not_found'           => __( 'No Partner Slide found', 'text_domain' ),
		'not_found_in_trash'  => __( 'No Partner Slide found in Trash', 'text_domain' ),
	);
	$args = array(
		'label'               => __( 'Partner Slides', 'text_domain' ),
		'description'         => __( 'Partner Slides', 'text_domain' ),
		'labels'              => $labels,
	...
	register_post_type( 'partner_slides', $args );
}
...
function fits_downloads_post_type() {
	...
	$args = array(
		...
		'description'         => __( 'FITS Team', 'text_domain' ),
		'labels'              => $labels,
		'supports'            => array( 'title', 'excerpt', 'featured', 'categories'),
		'taxonomies'          => array( 'category'),
		'hierarchical'        => false,
		'public'              => true,
		'show_ui'             => true,
